...
//  Swift_firstView
//
//  Created by Bhuvan Sharma on 23/01/16.
...
class Meal: NSObject, NSCoding {
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        let photo1 = aDecoder.decodeObjectForKey(propertyKey.photoKey) as? UIImage
            ...
            // to check what decodeObjectForKey returns.
        
        let rating1 = aDecoder.decodeIntegerForKey(propertyKey.ratingKey)
        
        //print(aDecoder.decodeObjectForKey(propertyKey.ratingKey) as! Int)
        //let rating1 = aDecoder.decodeIntForKey(propertyKey.ratingKey)
        //let rating1 = aDecoder.decodeObjectForKey(propertyKey.ratingKey) as! Int
